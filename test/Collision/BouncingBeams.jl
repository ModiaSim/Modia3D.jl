...
BouncingBeams = Model3D(
    ...
    jointX = FreeMotion(obj1=:frameX, obj2=:beamX,
                        ...
                        rot=Var(init=Modia.SVector{3,Float64}(0.0, -50*u"°", 0.0)),
                        v=Var(init=Modia.SVector{3,Float64}(0.0, 2.0, 0.0)),
    ...
    jointY = FreeMotion(obj1=:frameY, obj2=:beamY,
                        r=Var(init=Modia.SVector{3,Float64}(0.0, 0.0, 0.0)),
                        rot=Var(init=Modia.SVector{3,Float64}(0.0, 0.0, -50*u"°")),
                        v=Var(init=Modia.SVector{3,Float64}(0.0, 0.0, 2.0)),
                        w=Var(init=Modia.SVector{3,Float64}(0.0, 2.0, 0.0))),
    ...
    jointZ = FreeMotion(obj1=:frameZ, obj2=:beamZ,
                        r=Var(init=Modia.SVector{3,Float64}(0.0, 0.0, 0.0)),
                        rot=Var(init=Modia.SVector{3,Float64}(-50*u"°", 0.0, 0.0)),
                        v=Var(init=Modia.SVector{3,Float64}(2.0, 0.0, 0.0)),
                        w=Var(init=Modia.SVector{3,Float64}(0.0, 0.0, 2.0)))
)
