...
simulate!(billard, stopTime=testTime, tolerance=tolerance, interval=interval, log=true, useRecursiveFactorizationUptoSize=500, logStates=false, logTiming=true, logEvents=false, requiredFinalStates=requiredFinalStates)
