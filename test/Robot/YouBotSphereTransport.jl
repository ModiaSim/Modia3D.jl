...
elseif Sys.isapple()
    ...
    requiredFinalStates = [3.141594735321678, 2.4404978599455074e-6, 0.06413101846790158, -0.38051837256375953, 1.5066656031374528, 0.3805176609038324, 0.08493817930749148, -0.5038810239512538, -4.666045290288039e-7, 3.75336702448545e-7, 0.02640055988956694, -0.05767988877713214, -0.3856115369581726, -0.13530694918791783, 0.0033529368393173204, -0.13321890078262605, 0.04978725234892431, -6.996451010187938e-6, -0.7775599666597154, 0.0051071637842, 0.3801567785827783, 0.049032292414651756, 4.303938501405635e-6, 0.10223604722361752, -0.22440152482633344, 0.5085785126882857, 6.393572197528028, 5.535261914977968e-7, 0.5044004852080285, -2.4729442182791356e-6]
end


simulate!(youbot, stopTime=stopTime, tolerance=tolerance, requiredFinalStates_rtol=0.01, requiredFinalStates_atol=0.1, log=true, logStates=false, logParameters=false, requiredFinalStates=requiredFinalStates, logEvents=false)
