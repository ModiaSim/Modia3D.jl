module Test_Dynamic_Pendulum_yAxis
...
@assembly DoublePendulum(;Lx = 1.0, m=1.0) begin
   ...
   bar1  = Bar(Lx=Lx, m=m)
   bar2  = Bar(Lx=Lx, m=m)
   rev1  = Modia3D.Revolute(world, bar1.frame1; axis = 2)
   rev2  = Modia3D.Revolute(bar1.frame2, bar2.frame1; axis = 2)
end
...
println("... success of Test_Dynamic_Pendulum_yAxis.jl!")
end
