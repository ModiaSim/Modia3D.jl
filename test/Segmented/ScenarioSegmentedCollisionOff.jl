module ScenarioSegmentedCollisionOff
...
function robotProgram(robotActions)
    ...
    ActionAttach(robotActions, "sphereLock", "youbot1.base.plateLock", waitingPeriod=0.0, enableContactDetection=false)
    ...
    ActionRelease(robotActions, "sphereLock", waitingPeriod=0.0, enableContactDetection=true)
    ...
    ActionAttach(robotActions, "sphereLock", "youbot1.gripper.gripperLock", enableContactDetection=false)
    ptpJointSpace(robotActions, [
    ...
    # Attach sphere to gripper
    ActionAttach(robotActions, "sphereLock", "youbot1.gripper.gripperLock", waitingPeriod=0.0, enableContactDetection=false)
