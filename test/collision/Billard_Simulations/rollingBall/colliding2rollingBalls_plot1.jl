module colliding2rollingBalls_plot1
...
result = ModiaMath.simulate!(model; stopTime=1.5, tolerance=1e-8, log=false, maxNumberOfSteps=1000)
...
println("... success of colliding2rollingBalls_plot1.jl!")
end
