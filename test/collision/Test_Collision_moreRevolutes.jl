...
zyl1    = Modia3D.Part(Modia3D.Solid(Modia3D.SolidCylinder(Dx, Lz), nothing, vred; contactMaterial = cmat),     [[0.0, 0.0, -Lz/2], [ 0.0, 0.0,Lz/2]])
zyl2    = Modia3D.Part(Modia3D.Solid(Modia3D.SolidCylinder(Dx, Lz), nothing, vred; contactMaterial = cmat),     [[0.0, 0.0, -Lz/2], [ 0.0, 0.0,Lz/2]])
...
#Modia3D.connect(green1.frames[2], zyl1.frames[1])
#Modia3D.connect(green1.frames[2], zyl2.frames[1])
#rev6 = Modia3D.Revolute(green1.frames[2], zyl1.frames[1])
#rev7 = Modia3D.Revolute(green1.frames[2], zyl2.frames[1])
