...
@assembly BallWithBall begin
  ...
  sphere     = Modia3D.Object3D(world, Modia3D.Solid(Modia3D.SolidSphere(3.0) , "Aluminium", vmat1; contactMaterial = cmat); r=[-3.0, 0.0, 1.0], fixed=true) # R=ModiaMath.rot2(-pi/3),
end
...
Lx = 3.5
s =  1.8 #2.7 #2.6996028006546 #2.249
