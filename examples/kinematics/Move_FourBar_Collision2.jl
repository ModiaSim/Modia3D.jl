...
@assembly Fourbar(;Lx = 0.1, Ly=Lx/5, Lz=Ly, groundWidth=Lx, groundHeight=0.1*Lx) begin
   ...
   rev4 = Modia3D.Revolute(bar3.frame1, bar4.frame0; phi_start =  NaN)   # phi_start = -pi/2

   rev5 = Modia3D.Revolute(bar3.frame2, bar5.frame1; phi_start = -pi/2)
   rev6 = Modia3D.Revolute(bar5.frame2, bar6.frame2; phi_start =  pi/2)
   rev7 = Modia3D.Revolute(bar6.frame1, bar4.frame2; phi_start =  NaN)
end
...
println("... success of Move_FourBar_Collision2.jl!")
end
