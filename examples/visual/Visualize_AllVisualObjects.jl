module Visualize_AllVisualObjects
...
# Objects3D
@assembly AllVisualObjects begin
   ...
   spring           = Modia3D.Object3D(world, Modia3D.Spring(0.3,0.7,        material=mat1); r=[-3.0,0.0, 0.0])
   gearWheel        = Modia3D.Object3D(world, Modia3D.GearWheel(0.5,0.8,     material=mat1); r=[ 4.5,0.0,-2.5])
   pipe             = Modia3D.Object3D(world, Modia3D.Pipe(0.5,0.8,          material=mat1); r=[ 3.0,0.0,-2.5])
   beam             = Modia3D.Object3D(world, Modia3D.Beam(0.4,0.5,0.3,      material=mat1); r=[ 1.5,0.0,-2.5])
   grid             = Modia3D.Object3D(world, Modia3D.Grid(1.0,0.6                        ); r=[ 0.0,0.0,-2.5])
   coordinateSystem = Modia3D.Object3D(world, Modia3D.CoordinateSystem(0.7                ); r=[-1.5,0.0,-2.5])
   fileMesh         = Modia3D.Object3D(world, Modia3D.FileMesh(filename,4.0, material=mat1); r=[-3.0,0.0,-2.5])
