...
@inline function visualizeShape(frame::Composition.Object3D, shape::ShapeType, id::Ptr{Void}, material::Graphics.Material, 
...
visualizeSphere(data::Graphics.Sphere, frame::Composition.Object3D, id::Ptr{Void}) =
          visualizeShape(frame, sphere, id, data.material, data.Dx, data.Dx, data.Dx)
visualizeSolidSphere(data::Solids.Solid, frame::Composition.Object3D, id::Ptr{Void}) =
          visualizeShape(frame, sphere, id, data.material, data.geo.Dx, data.geo.Dx, data.geo.Dx)
#
visualizeEllipsoid(data::Graphics.Ellipsoid, frame::Composition.Object3D, id::Ptr{Void}) =
          visualizeShape(frame, sphere, id, data.material, data.Dx, data.Dy, data.Dz)
visualizeSolidEllipsoid(data::Solids.Solid, frame::Composition.Object3D, id::Ptr{Void}) =
          visualizeShape(frame, sphere, id, data.material, data.geo.Dx, data.geo.Dy, data.geo.Dz)
#
visualizeBox(data::Graphics.Box, frame::Composition.Object3D, id::Ptr{Void}) =
          visualizeShape(frame, box, id, data.material, data.Lx, data.Ly, data.Lz)
visualizeSolidBox(data::Solids.Solid, frame::Composition.Object3D, id::Ptr{Void}) =
          visualizeShape(frame, box, id, data.material, data.geo.Lx, data.geo.Ly, data.geo.Lz)
#
visualizeCylinder(data::Graphics.Cylinder, frame::Composition.Object3D, id::Ptr{Void}) =
          visualizeShape(frame, cylinder, id, data.material, data.Dx, data.Dy, data.Lz)
visualizeSolidCylinder(data::Solids.Solid, frame::Composition.Object3D, id::Ptr{Void}) =
          visualizeShape(frame, cylinder, id, data.material, data.geo.Dx, data.geo.Dy, data.geo.Lz)
#
visualizeCone(data::Graphics.Cone, frame::Composition.Object3D, id::Ptr{Void}) =
          visualizeShape(frame, cone, id, data.material, data.Dx, data.Dy, data.Lz, data.extras)
visualizeSolidCone(data::Solids.Solid, frame::Composition.Object3D, id::Ptr{Void}) =
          visualizeShape(frame, cone, id, data.material, data.geo.Dx, data.geo.Dy, data.geo.Lz, data.geo.extras)
#
visualizeCapsule(data::Graphics.Capsule, frame::Composition.Object3D, id::Ptr{Void}) =
          visualizeShape(frame, capsule, id, data.material, data.Dx, data.Dy, data.Lz)
visualizeSolidCapsule(data::Solids.Solid, frame::Composition.Object3D, id::Ptr{Void}) =
          visualizeShape(frame, capsule, id, data.material, data.geo.Dx, data.geo.Dy, data.geo.Lz)
#
visualizeSpring(data::Graphics.Spring, frame::Composition.Object3D, id::Ptr{Void}) =
          visualizeShape(frame, spring, id, data.material, data.Dx, data.Dy, data.Lz, data.extras)
#
visualizeGearWheel(data::Graphics.GearWheel, frame::Composition.Object3D, id::Ptr{Void}) =
          visualizeShape(frame, gearwheel, id, data.material, data.Dx, data.Dy, data.Lz, data.extras)
#
visualizePipe(data::Graphics.Pipe, frame::Composition.Object3D, id::Ptr{Void}) =
          visualizeShape(frame, pipe, id, data.material, data.Dx, data.Dy, data.Lz, data.extras)
visualizeSolidPipe(data::Solids.Solid, frame::Composition.Object3D, id::Ptr{Void}) =
          visualizeShape(frame, pipe, id, data.material, data.geo.Dx, data.geo.Dy, data.geo.Lz, data.geo.extras)
#
visualizeBeam(data::Graphics.Beam, frame::Composition.Object3D, id::Ptr{Void}) =
          visualizeShape(frame, beam, id, data.material, data.Lx,data.Dy, data.Lz)
visualizeSolidBeam(data::Solids.Solid, frame::Composition.Object3D, id::Ptr{Void}) =
          visualizeShape(frame, beam, id, data.material, data.geo.Lx,data.geo.Dy, data.geo.Lz)
#
const DefaultMaterial = Graphics.Material()
visualizeCoordinateSystem(data::Graphics.CoordinateSystem, frame::Composition.Object3D, id::Ptr{Void}) =
          visualizeShape(frame, coordsys, id, DefaultMaterial, data.Lx, data.Lx, data.Lx)

#
visualizeGrid(data::Graphics.Grid, frame::Composition.Object3D, id::Ptr{Void}) =
          visualizeShape(frame, grid, id, DefaultMaterial, data.Lx, data.Ly, data.Lx, data.extras)
#
const emptyShaderName=" "
visualizeFileMesh(data::Graphics.FileMesh, frame::Composition.Object3D, id::Ptr{Void}) =
...
#
visualizeSolidFileMesh(data::Solids.Solid, frame::Composition.Object3D, id::Ptr{Void}) =
     SimVis_setFileObject(id, Cint(0), frame.r_abs, frame.R_abs,
