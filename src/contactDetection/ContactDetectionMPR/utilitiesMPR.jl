...
"""
function signedDistanceToLineSegmentWithR4(r1::SVector{3,Double64}, r2::SVector{3,Double64},
    r21::SVector{3,Double64}, e::SVector{3,Double64},
    r4_old::SVector{3,Double64}, d4_old::Double64=Double64(0.0))
...
"""
function signedDistanceToLineSegment(r1::SVector{3,Double64}, r2::SVector{3,Double64},
    r21::SVector{3,Double64}, e::SVector{3,Double64})
    # r = r1 + lambda*r21  (0 <= lambda <= 1)
    #
    # The closest point to the line is point r4, such that r21*r4 = 0
...
"""
function signedDistanceToPortal(r0::SVector{3,Double64}, r1::SVector{3,Double64},
    r2::SVector{3,Double64}, r3::SVector{3,Double64})
    # Determine unit normal on portal
    r21 = r2 - r1
    r31 = r3 - r1
    n   = cross(r21, r31)
