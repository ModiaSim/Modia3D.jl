...
"""
function isPointOnPortal(r4::SVector{3,F}, r1::SVector{3,F}, r2::SVector{3,F}, r3::SVector{3,F}) where F <: AbstractFloat
    r21 = r2 - r1
    r31 = r3 - r1
    r41 = r4 - r1
...
"""
function isNormalRayOnPortal(r1::SVector{3,F}, r2::SVector{3,F}, r3::SVector{3,F}) where F <: AbstractFloat
...
- onPortal: r is on the portal triangle
"""
function isr0RayOnPortal(r0::SVector{3,F}, r1::SVector{3,F}, r2::SVector{3,F}, r3::SVector{3,F}) where F <: AbstractFloat
    # Determine unit normal on portal
    n = cross(r2-r1, r3-r1)
    e = normalize(n)
