...
"""
function measFrameRotation(frameMeas::Object3D{F}; frameOrig::Union{Object3D{F}, Nothing}=nothing) where F <: AbstractFloat
...
"""
function measFramePosition(frameMeas::Object3D{F}; frameOrig::Union{Object3D{F}, Nothing}=nothing, frameCoord::Union{Object3D{F}, Nothing}=nothing) where F <: AbstractFloat
...
"""
function measFrameDistance(frameMeas::Object3D{F}; frameOrig::Union{Object3D{F}, Nothing}=nothing) where F <: AbstractFloat
...
"""
function measFrameRotVelocity(frameMeas::Object3D{F}; frameOrig::Union{Object3D{F}, Nothing}=nothing, frameCoord::Union{Object3D{F}, Nothing}=nothing) where F <: AbstractFloat
...
"""
function measFrameTransVelocity(frameMeas::Object3D{F}; frameOrig::Union{Object3D{F}, Nothing}=nothing, frameCoord::Union{Object3D{F}, Nothing}=nothing, frameObsrv::Union{Object3D{F}, Nothing}=nothing) where F <: AbstractFloat
...
"""
function measFrameDistVelocity(frameMeas::Object3D{F}; frameOrig::Union{Object3D{F}, Nothing}=nothing) where F <: AbstractFloat
...
"""
function measFrameRotAcceleration(frameMeas::Object3D{F}; frameOrig::Union{Object3D{F}, Nothing}=nothing, frameCoord::Union{Object3D{F}, Nothing}=nothing, frameObsrv::Union{Object3D{F}, Nothing}=nothing) where F <: AbstractFloat
...
"""
function measFrameTransAcceleration(frameMeas::Object3D{F}; frameOrig::Union{Object3D{F}, Nothing}=nothing, frameCoord::Union{Object3D{F}, Nothing}=nothing, frameObsrv::Union{Object3D{F}, Nothing}=nothing) where F <: AbstractFloat
...
"""
function measFrameDistAcceleration(frameMeas::Object3D{F}; frameOrig::Union{Object3D{F}, Nothing}=nothing) where F <: AbstractFloat
    # (n * v)d = n*vd + nd*v
    #          = n*a + [r/d]d*v
    #          = n*a + [(v*d - r*dd)/(d*d)]*v
