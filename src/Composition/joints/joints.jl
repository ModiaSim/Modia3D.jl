...
Return rotation matrix `R` from angles with rotation sequence x-z-y to
rotate from frame `1` to frame `2`.
"""
Rfromrot132(rot132::AbstractVector) = Modia3D.rot1(rot132[1])*Modia3D.rot3(rot132[3])*Modia3D.rot2(rot132[2])
