...
#function normalForce(c_res, d_res, delta, delta_dot::Float64, r::Float64) 
#  fn = -c_res*(4/3*delta*sqrt(r*abs(delta)))*(1-d_res*delta_dot)
#  println("... delta=",delta,", r=",r,",d_res=",d_res, ", delta_dot=", delta_dot)
#  return fn
#end
